...
$.ajax('taller/max_form.php')
    .done(function (msg) {
        $('#video19-output').html(msg);
    });
$.ajax('taller/min_form.php')
    .done(function (msg) {
        $('#video20-output').html(msg);
    });
$.ajax('taller/concat_form.php')
    .done(function (msg) {
        $('#video22-output').html(msg);
    });
$.ajax('taller/repeat_form.php')
    .done(function (msg) {
        $('#video23-output').html(msg);
    });
$.ajax('taller/extract_form.php')
    .done(function (msg) {
        $('#video24-output').html(msg);
    });
$.ajax('taller/isText_form.php')
    .done(function (msg) {
